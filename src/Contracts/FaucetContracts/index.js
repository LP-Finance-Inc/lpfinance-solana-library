...
import lendingIDL from "../../idls/lending_tokens.json";
import * as LENDING_Constants from "../../helpers/constants/lending_constants";
import {
  btcMint,
  usdcMint,
  msolMint,
...
// Enter depositing
export const request_faucet = async (keyword, wallet, amount) => {
