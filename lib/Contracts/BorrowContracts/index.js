  ...
  if (TokenName === "SOL") {
    if (
      ...
      try {
        ...
        return {
          message: `Successfully deposited ${CeilMethod(amount)} ${TokenName}.`,
        };
      } catch (err) {
        console.log(err);
        return {
    ...
    if (TokenName === "lpUSD") {
      ...
      return {
        message: "Please select valid token",
      };
    }
...
export const borrowCBS = async (wallet, amount, TokenName) => {
  ...
  if (
    ...
    try {
      ...
      return {
        message: `Successfully borrowed ${CeilMethod(amount)} ${TokenName}.`,
      };
    } catch (err) {
      return {
        message: "Borrow failed",
...
export const withdrawCBS = async (wallet, amount, TokenName) => {
  ...
  if (TokenName === "SOL") {
    try {
      ...
      return {
        message: `Successfully Withdraw ${CeilMethod(amount)} ${TokenName}.`,
      };
    } catch (err) {
      return {
...
export const repayCBS = async (wallet, amount, TokenName) => {
  ...
  if (TokenName === "SOL") {
    try {
      ...
      return {
        message: `Successfully repayment ${CeilMethod(amount)} ${TokenName}.`,
      };
    } catch (error) {
      return {
